...
{
    //目录
    public static readonly string LevelDir = Application.dataPath + @"\Game\Resources\LevelConfig\";
    ...
    public const string E_GoldChange = "E_GoldChange";
    public const string E_GameSpeedChange = "E_GameSpeedChange";
    ...
    public const string E_RoundChange = "E_RoundChange";
}
